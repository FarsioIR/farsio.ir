...
const routes = [
  ...
  ["/products/avayar/privacy", "page", "حریم خصوصی آوایار | دسترسی‌ها و جریان داده | فارسیو", "سیاست رسمی حریم خصوصی آوایار؛ دسترسی‌های افزونه، پردازش محتوای صفحه، اتصال HTTPS و مرزهای داده نسخه ۰.۶.۰ پایدار.", "AvaYar Privacy | Permissions & Data Flow | Farsio", "Official AvaYar privacy information covering extension permissions, webpage-content processing, HTTPS service use and the Stable 0.6.0 data-flow boundary."],
  ["/products/avayar/support", "page", "پشتیبانی آوایار | راهنما و گزارش مشکل | فارسیو", "صفحه رسمی پشتیبانی آوایار برای راهنما، بررسی نسخه، گزارش خطا، GitHub Issues و ارتباط با فارسیو.", "AvaYar Support | Help & Issue Reporting | Farsio", "Official AvaYar support for release verification, troubleshooting, GitHub issue reporting and contacting Farsio."],
